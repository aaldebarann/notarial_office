 ...
 */
    ...
    class public_customerPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new NumberViewColumn('customer_id', 'customer_id', 'Customer Id', $this->dataset);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('customer_id_edit');
            $editColumn = new CustomEditColumn('Customer Id', 'customer_id', $editor, $this->dataset);
            ...
            //
            $editor = new TextAreaEdit('phone_number_edit', 50, 8);
    ...
    try
    {
        $Page = new public_customerPage("public_customer", "customer.php", GetCurrentUserPermissionsForPage("public.customer"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.customer"));
