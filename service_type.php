 ...
 */
    ...
    class public_service_typePage extends Page
    {
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'service_type', 'service_type', 'Service Type'),
                ...
                new FilterColumn($this->dataset, 'comission', 'comission', 'Comission')
            );
        }
        ...
        {
            //
            // View column for service_type field
            //
            $column = new NumberViewColumn('service_type', 'service_type', 'Service Type', $this->dataset);
            ...
            $grid->AddViewColumn($column);
            //
            // View column for comission field
            //
            $column = new TextViewColumn('comission', 'comission', 'Comission', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('service_type_edit');
            $editColumn = new CustomEditColumn('Service Type', 'service_type', $editor, $this->dataset);
            ...
            //
            // Edit column for comission field
            //
            $editor = new TextEdit('comission_edit');
            $editColumn = new CustomEditColumn('Comission', 'comission', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
    ...
    try
    {
        $Page = new public_service_typePage("public_service_type", "service_type.php", GetCurrentUserPermissionsForPage("public.service_type"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.service_type"));
