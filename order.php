 ...
 */
    ...
    class public_orderPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Order');
            $this->SetMenuLabel('Order');
            ...
            $this->dataset->AddLookupField('customer_id', 'public.customer', new IntegerField('customer_id'), new StringField('name', false, false, false, false, 'LA1', 'LT1'), 'LT1');
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'customer_id', 'LA1', 'Customer Id'),
                new FilterColumn($this->dataset, 'service_id', 'service_id', 'Service Id'),
                new FilterColumn($this->dataset, 'order_date', 'order_date', 'Order Date')
            );
        }
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('customer_id', 'LA1', 'Customer Id', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            $column = new DateTimeViewColumn('order_date', 'order_date', 'Order Date', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new ComboBox('customer_id_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            ...
            $lookupDataset->addFields(
                array(
                    new IntegerField('customer_id', true, true),
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'customer_id', 
                $editor, 
                $this->dataset, 'customer_id', 'name', $lookupDataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
            ...
            $editColumn = new CustomEditColumn('Order Date', 'order_date', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
    ...
    try
    {
        $Page = new public_orderPage("public_order", "order.php", GetCurrentUserPermissionsForPage("public.order"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.order"));
